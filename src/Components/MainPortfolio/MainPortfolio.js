...
export class MainPortfolio extends Component {
    render() {
        return (
            <div className="nk-portfolio-list nk-isotope nk-isotope-2-cols nk-isotope-gap">
                            ...
                            <div className="nk-isotope-item" data-filter="Branding">
                                <div className="nk-portfolio-item nk-portfolio-item-info-style-4">
                                    ...
                                    <div className="nk-portfolio-item-info">
                                        <div>
